...
func (m *ListPluginRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetFuzzyName()) < 0 {
		err := ListPluginRequestValidationError{
			field:  "FuzzyName",
	...
	if utf8.RuneCountInString(m.GetSortByFieldName()) < 0 {
		err := ListPluginRequestValidationError{
...
// Validate checks the field values on CreatePluginRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CreatePluginRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreatePluginRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CreatePluginRequestMultiError, or nil if none found.
func (m *CreatePluginRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CreatePluginRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetDomain()) < 1 {
		err := CreatePluginRequestValidationError{
			field:  "Domain",
	...
	if utf8.RuneCountInString(m.GetLabel()) < 0 {
		err := CreatePluginRequestValidationError{
			field:  "Label",
			reason: "value length must be at least 0 runes",
		}
	...
	if len(errors) > 0 {
		return CreatePluginRequestMultiError(errors)
	}

	return nil
}

// CreatePluginRequestMultiError is an error wrapping multiple validation
// errors returned by CreatePluginRequest.ValidateAll() if the designated
// constraints aren't met.
type CreatePluginRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreatePluginRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreatePluginRequestMultiError) AllErrors() []error { return m }

// CreatePluginRequestValidationError is the validation error returned by
// CreatePluginRequest.Validate if the designated constraints aren't met.
type CreatePluginRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreatePluginRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreatePluginRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreatePluginRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreatePluginRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreatePluginRequestValidationError) ErrorName() string {
	return "CreatePluginRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CreatePluginRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreatePluginRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreatePluginRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreatePluginRequestValidationError{}

// Validate checks the field values on CreatePluginScoreRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CreatePluginScoreRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreatePluginScoreRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CreatePluginScoreRequestMultiError, or nil if none found.
func (m *CreatePluginScoreRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CreatePluginScoreRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetPluginId() <= 0 {
		err := CreatePluginScoreRequestValidationError{
			field:  "PluginId",
	...
	if utf8.RuneCountInString(m.GetComments()) < 0 {
		err := CreatePluginScoreRequestValidationError{
			field:  "Comments",
			reason: "value length must be at least 0 runes",
		}
	...
	if len(errors) > 0 {
		return CreatePluginScoreRequestMultiError(errors)
	}

	return nil
}

// CreatePluginScoreRequestMultiError is an error wrapping multiple validation
// errors returned by CreatePluginScoreRequest.ValidateAll() if the designated
// constraints aren't met.
type CreatePluginScoreRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreatePluginScoreRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreatePluginScoreRequestMultiError) AllErrors() []error { return m }

// CreatePluginScoreRequestValidationError is the validation error returned by
// CreatePluginScoreRequest.Validate if the designated constraints aren't met.
type CreatePluginScoreRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreatePluginScoreRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreatePluginScoreRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreatePluginScoreRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreatePluginScoreRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreatePluginScoreRequestValidationError) ErrorName() string {
	return "CreatePluginScoreRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CreatePluginScoreRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreatePluginScoreRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreatePluginScoreRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreatePluginScoreRequestValidationError{}
